...
Service return `HTTP Status Code` which is defined in URL.

## :rotating_light: WARNING: Service is not available

I will recommend <https://httpbin.org/>
...
* Polish: <https://pl.wikipedia.org/wiki/Kod_odpowiedzi_HTTP>
